            ...
            <div className="flex-1 flex">
              ...
              <div className="w-64 bg-gray-900/20 border-r border-gray-700/30 backdrop-blur-sm">
                <div className="p-4 border-b border-gray-700/30">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-center gap-2 text-gray-300 hover:text-white cursor-pointer ml-4">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="flex items-center gap-2 p-2 bg-gray-900/20 border-b border-gray-700/30">
                  <div className="px-4 py-2 bg-gray-800/40 border border-gray-600/30 rounded-lg text-sm text-white">
                    app.js
                  </div>
                ...
                <div className="flex-1 bg-gray-900/10">
                  <div className="h-full p-6 font-mono text-sm">
                    <div className="text-gray-400 mb-4">// Generated by FlashFusion AI</div>
                    ...
                    <br />
                    <div className="text-blue-400">import</div> <div className="text-white">{ useState }</div> <div className="text-blue-400">from</div> <div className="text-green-400">'react'</div><div className="text-white">;</div>
                    <br /><br />
                    <div className="text-blue-400">function</div> <div className="text-yellow-400">App</div><div className="text-white">() {</div>
                    <br />
                    <div className="ml-4 text-blue-400">const</div> <div className="text-white">[count, setCount] = useState(0);</div>
                    <br /><br />
                    <div className="ml-4 text-blue-400">return</div> <div className="text-white">(</div>
                    <br />
                    <div className="ml-8 text-purple-400">&lt;div</div> <div className="text-blue-400">className</div><div className="text-white">=</div><div className="text-green-400">"app"</div><div className="text-purple-400">&gt;</div>
                    <br />
                    <div className="ml-12 text-purple-400">&lt;h1&gt;</div><div className="text-white">FlashFusion App</div><div className="text-purple-400">&lt;/h1&gt;</div>
                    <br />
                    <div className="ml-12 text-purple-400">&lt;button</div> <div className="text-blue-400">onClick</div><div className="text-white">=</div><div className="text-yellow-400">{() =&gt; setCount(count + 1)}</div><div className="text-purple-400">&gt;</div>
                    <br />
                    <div className="ml-16 text-white">Count: {count}</div>
                    <br />
                    <div className="ml-12 text-purple-400">&lt;/button&gt;</div>
                    <br />
              ...
              <div className="w-80 bg-gray-900/20 border-l border-gray-700/30 backdrop-blur-sm flex flex-col">
                ...
                <div className="p-4 border-t border-gray-700/30">
                  <div className="flex gap-2">
                    ...
                    />
                    <button className="px-3 py-2 bg-purple-500 hover:bg-purple-600 text-white rounded-lg transition-all">
