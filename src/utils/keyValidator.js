    ...
    constructor() {
        this.validators = {
            OPENAI_API_KEY: {
                ...
                message: 'OpenAI key should start with "sk-" followed by alphanumeric characters'
            },
            ANTHROPIC_API_KEY: {
                pattern: /^sk-ant-api\d{2}-[A-Za-z0-9\-_]{32,}$/,
                message: 'Anthropic key should start with "sk-ant-api" followed by version and key'
            },
            SUPABASE_URL: {
