...
export class SecureApiKeyService {
   ...
   */
  private static matchesProvider(apiKey: string, config: ApiKeyConfig): boolean {
    return apiKey.startsWith(config.prefix) && 
   ...
   */
  public static getApiKeyFromEnv(provider: 'openai' | 'anthropic'): string | null {
