...
class ZapierService {
    ...
    async triggerWebhook(eventType, data, options = {}) {
        ...
        if (!webhook || !webhook.active) {
            return { success: false, error: `No active webhook found for event: ${eventType}` };
        }
    ...
    async chainWebhooks(eventType, data, webhookUrls) {
        ...
        for (const url of webhookUrls) {
            try {
                const result = await this.triggerWebhook(eventType, data, { webhookUrl: url });
    ...
    getAutomationSuggestions(category = 'all') {
        ...
        return this.automationSuggestions.filter(suggestion => 
    ...
    initializeAutomationSuggestions() {
        this.automationSuggestions = [
            // Business Automation
            {
                ...
                description: 'Automatically add new leads from FlashFusion to your CRM (Salesforce, HubSpot, Pipedrive)',
                category: 'business',
                triggers: ['lead_generated', 'contact_form_submitted'],
                actions: ['Create CRM contact', 'Send welcome email', 'Assign to sales rep'],
            ...
            },
            {
                ...
                description: 'Update project management tools when FlashFusion workflows complete',
                category: 'business',
                triggers: ['workflow_completed', 'milestone_reached'],
                actions: ['Update Asana task', 'Send Slack notification', 'Create Trello card'],
            ...
            // E-commerce Automation
            {
                ...
                description: 'Sync new orders across inventory, accounting, and shipping systems',
                category: 'ecommerce',
                triggers: ['order_created', 'payment_received'],
                actions: ['Update inventory', 'Create invoice', 'Generate shipping label'],
            ...
            },
            {
                ...
                description: 'Route customer support tickets to appropriate AI agents for initial response',
                category: 'ecommerce',
                triggers: ['support_ticket_created', 'customer_complaint'],
                actions: ['Analyze sentiment', 'Generate AI response', 'Escalate if needed'],
            ...
            // Content & Marketing
            {
                ...
                description: 'Automatically distribute AI-generated content across social media and blogs',
                category: 'marketing',
                triggers: ['content_generated', 'blog_post_created'],
                actions: ['Post to Twitter', 'Share on LinkedIn', 'Update blog', 'Send newsletter'],
            ...
            },
            {
                ...
                description: 'Trigger personalized email sequences based on AI-calculated lead scores',
                category: 'marketing',
                triggers: ['lead_score_updated', 'engagement_detected'],
                actions: ['Send targeted email', 'Add to campaign', 'Update lead status'],
            ...
            // Data & Analytics
            {
                ...
                description: 'Send FlashFusion performance data to analytics and reporting tools',
                category: 'analytics',
                triggers: ['metrics_calculated', 'report_generated'],
                actions: ['Update Google Sheets', 'Send to Data Studio', 'Create chart'],
            ...
            },
            {
                ...
                description: 'Automatically notify teams and create tickets for system errors',
                category: 'analytics',
            ...
            // Team Collaboration
            {
                ...
                description: 'Keep teams informed about AI agent activities and decisions',
                category: 'collaboration',
                triggers: ['agent_decision_made', 'task_completed'],
                actions: ['Send team notification', 'Update status board', 'Log activity'],
            ...
            },
            {
                ...
                description: 'Sync FlashFusion meeting scheduling across calendar platforms',
                category: 'collaboration',
                triggers: ['meeting_scheduled', 'appointment_booked'],
                actions: ['Add to Google Calendar', 'Send Outlook invite', 'Create Zoom meeting'],
            ...
            // Advanced Automations
            {
                ...
                description: 'Chain multiple tools together for sophisticated business workflows',
                category: 'advanced',
                triggers: ['custom_event', 'complex_condition_met'],
                actions: ['Multi-step processing', 'Conditional logic', 'Error handling'],
