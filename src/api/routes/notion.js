...
router.post('/databases/:id/pages', async (req, res) => {
    try {
        ...
        const result = await notionService.createPage(databaseId, properties, content);
        res.json(result);
    } catch (error) {
...
router.post('/workflow-integration', async (req, res) => {
    try {
        ...
        const result = await notionService.createWorkflowIntegration(workflowId, notionConfig);
        res.json(result);
    } catch (error) {
    ...
    try {
        ...
        switch (action) {
            case 'create_task_page':
                ...
                result = await notionService.createPage(parameters.databaseId, taskProperties);
                break;

            case 'search_pages':
                result = await notionService.search(parameters.query || '', parameters.filters || {});
                break;
            ...
            case 'update_task_status':
                ...
                result = await notionService.updatePage(parameters.pageId, updateProperties);
                break;
